...
fig_total_trends_proms_sem_tag <- df_fig_proms_anx_dep_usage |> 
    ggplot(
      aes(
        y = usage,
        x = end_date,
...
# ggsave(
#   filename = here("output", "figures", "occ", "fig_total_trends_proms-sem_tag.png"),
#   fig_total_trends_proms_sem_tag ,
#   height = 3.5,
#   width = 6
# )
...
# dir.create(here("output", "tables", "occ"), recursive = TRUE, showWarnings = FALSE)
# gtsave(
#   tab_top5_proms_anx_dep_usage,
#   here("output", "tables", "occ", "tab_top5_proms_usage.png")
#   )
